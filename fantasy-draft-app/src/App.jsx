...
import {
  ...
  CircleDot, Zap, FastForward, Dices
} from "lucide-react";
...
const SAMPLE = {
  QB: [
    ["Josh Allen","BUF",7,1,398.5,412.3,17,25,null,"Locked in as elite rushing/passing dual threat. No offseason surgeries reported."],
    ["Lamar Jackson","BAL",14,2,389.2,401.1,16,28,null,"Missed one game late season with knee soreness; fully cleared for offseason program."],
    ["Jayden Daniels","WAS",12,3,372.0,378.4,17,35,null,"Entering year 2, expanded route tree for weapons around him."],
    ["Patrick Mahomes","KC",10,4,365.8,358.9,17,40,null,"New OC hire expected to open up downfield passing game."],
    ["Joe Burrow","CIN",10,5,358.1,349.2,17,45,null,"Fully healthy after prior wrist injury, no limitations."],
    ["Jalen Hurts","PHI",9,6,352.4,360.7,16,30,null,"Tush push usage may decrease slightly per coaching staff comments."],
    ["C.J. Stroud","HOU",6,7,340.6,331.5,17,55,null,"Improved offensive line via free agency additions."],
    ["Justin Herbert","LAC",8,8,335.9,328.0,17,60,null,"New weapons added at WR this offseason."],
    ["Kyler Murray","ARI",11,9,318.2,309.8,16,70,null,"Camp battle for starting job not expected; entrenched starter."],
    ["Bo Nix","DEN",12,10,312.5,305.1,17,80,null,"Second-year leap candidate with weapons upgrade."],
    ["Brock Purdy","SF",9,11,308.7,300.4,15,85,null,"Coming off shoulder injury, monitor camp reps."],
    ["Anthony Richardson","IND",14,12,300.1,262.3,11,75,null,"High rushing ceiling but accuracy concerns persist."],
    ["Caleb Williams","CHI",5,13,296.4,288.9,17,78,null,"New head coach installing more QB-friendly scheme."],
    ["Dak Prescott","DAL",10,14,290.8,275.2,12,90,null,"Returning from hamstring injury, full participant in offseason work."],
    ["Trevor Lawrence","JAX",8,15,278.3,265.0,15,95,null,"New coaching staff emphasizing quick-game passing."],
  ],
  RB: [
    ["Bijan Robinson","ATL",11,1,325.4,318.2,17,1,null,"Workhorse role fully established, minimal committee usage."],
    ["Jahmyr Gibbs","DET",8,2,312.8,320.5,16,5,null,"Shares backfield but leads in high-value touches and receiving work."],
    ["Ashton Jeanty","LV",4,3,298.6,285.1,17,10,null,"Rookie year exceeded expectations; entrenched as lead back entering year 2."],
    ["Saquon Barkley","PHI",9,4,295.3,310.7,16,8,null,"Age-related regression watch, but offensive line remains elite."],
    ["De'Von Achane","MIA",12,5,288.9,275.4,15,15,null,"Explosive but has missed time with minor injuries in past two seasons."],
    ["Christian McCaffrey","SF",9,6,282.1,290.3,14,12,null,"Injury history is a real concern; monitor camp workload."],
    ["Jonathan Taylor","IND",14,7,278.5,295.8,17,18,null,"Coming off career year, contract situation resolved."],
    ["Derrick Henry","BAL",14,8,270.2,288.6,17,22,null,"Age 32, but showed no signs of slowing in prior season."],
    ["Kyren Williams","LAR",8,9,265.7,258.3,17,25,null,"Goal-line role secure, mild receiving-work upside."],
    ["Josh Jacobs","GB",5,10,260.4,268.9,17,28,null,"Featured back in run-heavy offense."],
    ["Breece Hall","NYJ",9,11,255.8,240.1,16,30,null,"New coaching staff expected to feature him more in passing game."],
    ["James Cook","BUF",7,12,248.3,252.7,17,35,null,"Extension signed, workload expected to stay stable."],
    ["Chase Brown","CIN",10,13,242.6,238.4,17,45,null,"Emerged as lead back, minimal competition on roster."],
    ["Bucky Irving","TB",9,14,238.1,245.2,16,50,null,"Efficient dual-threat back with expanding role."],
    ["Alvin Kamara","NO",11,15,225.4,230.8,15,48,null,"Aging veteran but remains involved in passing downs."],
    ["Kenneth Walker III","SEA",8,16,220.7,215.3,15,55,null,"Injury-prone but explosive when healthy."],
    ["Tony Pollard","TEN",10,17,210.2,205.6,17,70,null,"Lead back role but offense projects as pass-funnel negative game script."],
    ["Aaron Jones","MIN",6,18,205.5,212.4,13,75,null,"Timeshare back, touchdown-dependent scoring."],
    ["Isiah Pacheco","KC",10,19,198.3,190.7,12,80,null,"Returning from injury, camp health is the main question."],
    ["Rachaad White","TB",9,20,190.6,195.4,17,90,null,"Complementary back behind Irving, limited standalone value."],
  ],
  WR: [
    ["Ja'Marr Chase","CIN",10,1,335.2,342.8,17,2,null,"Elite target share with healthy Joe Burrow, no concerns."],
    ["Justin Jefferson","MIN",6,2,320.6,315.4,17,3,null,"Locked in as WR1 target hog regardless of QB play."],
    ["CeeDee Lamb","DAL",10,3,308.4,298.7,15,4,null,"Fully healthy after shoulder injury late last season."],
    ["Malik Nabers","NYG",14,4,300.1,305.9,15,6,null,"Elite target volume, offense around him remains a question."],
    ["Amon-Ra St. Brown","DET",8,5,296.8,290.2,17,7,null,"PPR floor is elite due to short-target usage."],
    ["Nico Collins","HOU",6,6,288.5,278.9,15,11,null,"Healthy entering camp after missing time to injury last year."],
    ["Puka Nacua","LAR",8,7,282.3,275.6,15,13,null,"Injury history is the main risk, otherwise elite target earner."],
    ["Brian Thomas Jr.","JAX",8,8,275.7,268.4,17,20,null,"Entering year 2 as clear WR1 in new-look offense."],
    ["A.J. Brown","PHI",9,9,270.2,255.8,15,14,null,"Reported frustration with target share resolved via offseason talks."],
    ["Drake London","ATL",11,10,265.4,260.1,17,16,null,"Red zone role expanded, consistent target hog."],
    ["Ladd McConkey","LAC",8,11,258.9,252.3,17,24,null,"Slot role secure with expanded route tree."],
    ["Tyreek Hill","MIA",12,12,250.3,220.5,13,17,null,"Coming off down year and ankle injury, upside/risk profile."],
    ["Marvin Harrison Jr.","ARI",11,13,245.6,238.2,16,19,null,"Year 2 leap candidate with improved QB chemistry."],
    ["Davante Adams","LAR",8,14,240.1,258.7,17,26,null,"Aging but remains highly efficient target earner."],
    ["DK Metcalf","PIT",9,15,235.8,225.4,16,32,null,"New team fit still developing after trade."],
    ["Terry McLaurin","WAS",12,16,230.2,240.6,17,38,null,"Consistent target share in ascending offense."],
    ["Garrett Wilson","NYJ",9,17,225.7,232.1,17,40,null,"New coaching staff installing more WR-friendly scheme."],
    ["DJ Moore","CHI",5,18,218.4,222.8,17,50,null,"Steady target earner with new coaching staff."],
    ["Jaxon Smith-Njigba","SEA",8,19,215.1,228.3,17,42,null,"Breakout campaign last season, expected lead WR role."],
    ["Mike Evans","TB",9,20,210.6,215.9,16,45,null,"Consistent touchdown producer, age-related decline risk."],
  ],
  TE: [
    ["Brock Bowers","LV",4,1,245.8,268.4,17,21,null,"Elite target volume for the position, locked in as focal point of passing game."],
    ["Trey McBride","ARI",11,2,228.3,235.7,17,33,null,"Established as top target earner in Arizona's offense."],
    ["Sam LaPorta","DET",8,3,210.5,205.2,16,36,null,"Target share dipped slightly with WR additions, still strong red zone role."],
    ["George Kittle","SF",9,4,198.7,215.6,15,41,null,"Age-related risk but remains highly involved when healthy."],
    ["Mark Andrews","BAL",14,5,185.2,178.9,15,52,null,"Touchdown-dependent scoring profile, target share modest."],
    ["T.J. Hockenson","MIN",6,6,178.6,188.3,16,60,null,"Fully healthy after prior ACL recovery."],
    ["Evan Engram","DEN",12,7,165.4,170.2,16,75,null,"Consistent target earner in new offense."],
    ["Kyle Pitts","ATL",11,8,158.9,155.4,17,65,null,"Long-awaited breakout still unrealized, boom/bust profile."],
    ["David Njoku","CLE",9,9,152.3,160.8,15,80,null,"Steady red zone role in offense-in-transition."],
    ["Dalton Kincaid","BUF",7,10,148.7,142.5,15,85,null,"Competing for targets in run-heavy offense."],
    ["Jake Ferguson","DAL",10,11,140.2,148.6,17,95,null,"Reliable underneath option, capped ceiling."],
    ["Dallas Goedert","PHI",9,12,135.6,138.4,14,100,null,"Committee role behind receivers, touchdown-dependent."],
  ],
  K: [
    ["Brandon Aubrey","DAL",10,1,152.0,158.3,17,140,null,"Elite leg strength, high-volume attempt offense."],
    ["Chris Boswell","PIT",9,2,148.5,152.1,17,150,null,"Accurate veteran in a low-scoring, field-goal-heavy offense."],
    ["Jake Bates","DET",8,3,144.2,146.8,17,155,null,"Big leg, high powered offense generates lots of attempts."],
    ["Harrison Butker","KC",10,4,140.8,138.5,17,160,null,"Consistent scorer in efficient red zone offense."],
    ["Cameron Dicker","LAC",8,5,138.1,135.9,17,165,null,"Reliable accuracy, improving offense around him."],
  ],
  DEF: [
    ["Broncos","DEN",12,1,145.2,150.4,17,110,null,"Aggressive pass rush generates high sack and turnover totals."],
    ["Eagles","PHI",9,2,140.6,138.9,17,115,null,"Deep defensive line rotation, strong takeaway numbers."],
    ["Steelers","PIT",9,3,136.3,142.7,17,120,null,"Perennially strong unit with veteran leadership."],
    ["Vikings","MIN",6,4,132.8,130.5,17,125,null,"Aggressive scheme creates frequent turnover opportunities."],
    ["49ers","SF",9,5,128.4,135.6,17,130,null,"Talented front seven, injury durability is the main risk."],
  ],
};

const FIELDS = ["player","team","bye_week","rank","predicted_fantasy_pts","fantasy_pts_2025","games_played_2025","espn_rank","espn_id","news_details"];
    ...
    Papa.parse(file, {
      ...
      complete: (res) => {
        const rows = res.data.map((r, i) => ({
          ...
          espn_rank: r.espn_rank ? Number(r.espn_rank) : null,
          espn_id: r.espn_id ? Number(r.espn_id) : null,
    ...
    <div style={{ maxWidth: 880, margin: "0 auto", padding: isMobile ? "24px 14px 60px" : "40px 20px 70px" }}>
      ...
      <div style={{ background: COLORS.surface, border: `1px solid ${COLORS.line}`, borderRadius: 10, padding: 18, marginBottom: 28 }}>
        ...
        <p style={{ fontSize: 12, color: COLORS.muted, marginBottom: 12 }}>
          ...
          fantasy_pts_2025, games_played_2025, espn_rank, espn_id, news_details. Uploading replaces the
          sample data for that position only. Run <code>npm run fetch:espn</code> to populate espn_rank/espn_id
          from ESPN's public rankings.
        </p>
